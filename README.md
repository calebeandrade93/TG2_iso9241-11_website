...
Faça o clone do repositório e entre na pasta website <br/>
Execute o comando no bash: ```python -m venv .venv```  <br/>
Para habilitar o ambiente virtual, no bash execute dentro da pasta website ```source .venv/Scripts/activate```  <br/>
Após habilitar o ambiente virtual, execute o comando ```python.exe -m pip install --upgrade pip``` para atualizar o pip  <br/>
Após atualizar o ambiente pip, execute o comando no bash ```pip install -r requirements.txt``` para realizar o download das dependencias.  <br/>
